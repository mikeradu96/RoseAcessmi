...
const LanguageWorkshops = () => {
  ...
  return (
    <sector>
      <div className="container tlwBackground">
        <h1 className={classes.centeredtxt}>Technical Language <br/>Workshops</h1>
      </div>
      <p className={classes.englishtxt}>Technical Language Workshops</p>
      <Grid
  container
  direction="row"
...
>
      ...
      <CardActionArea>
        ...
        <CardContent>
          <Typography gutterBottom variant="h5" component="h2">
           <p className={classes.orangetxt}>ENGLISH WORKSHOP</p>
          </Typography>
    ...
    <Card className={classes.cards}>
      <CardActionArea>
        ...
        <CardContent>
          <Typography gutterBottom variant="h5" component="h2">
           <p className={classes.orangetxt}>FRENCH WORKSHOP</p>
          </Typography>
          <Button className={classes.cardbtn} variant="contained"  onClick={handleClickOpen}>
        ENROLL
      </Button>
